  ...
  return (
    <div className="p-6 space-y-6">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        <div className="p-4 rounded-xl bg-slate-900 border border-slate-800 flex items-center space-x-4">
          <div className="p-3 rounded-xl bg-indigo-500/10 text-indigo-400 border border-indigo-500/20">
            <BookOpen className="w-6 h-6" />
          </div>
          <div>
            <div className="text-2xl font-extrabold text-white">{stats?.totalRules || 128}</div>
        ...
        <div className="p-4 rounded-xl bg-slate-900 border border-slate-800 flex items-center space-x-4">
          ...
          <div>
            <div className="text-2xl font-extrabold text-white">{stats?.conflictsDetected || 42}</div>
        ...
        <div className="p-4 rounded-xl bg-slate-900 border border-slate-800 flex items-center space-x-4">
          ...
          <div>
            <div className="text-2xl font-extrabold text-white">{stats?.verificationsRun || 18}</div>
        ...
        <div className="p-4 rounded-xl bg-slate-900 border border-slate-800 flex items-center space-x-4">
          ...
          <div>
            <div className="text-2xl font-extrabold text-white">{stats?.passedCount || 12}</div>
