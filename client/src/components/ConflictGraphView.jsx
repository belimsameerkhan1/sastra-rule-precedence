...
export default function ConflictGraphView({ conflictsData }) {
  ...
  return (
    <div className="p-4 md:p-6 space-y-4 flex flex-col min-h-[calc(100vh-140px)]">
      {/* Top Controls Bar */}
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 shrink-0">
        <div>
          <div className="text-xs text-indigo-400 font-medium">Conflicts › Interactive Graph</div>
          <h2 className="text-lg md:text-xl lg:text-2xl font-bold text-white">Conflict Graph</h2>
        </div>
        ...
        <div className="flex flex-col sm:flex-row flex-wrap gap-3 w-full sm:w-auto">
          ...
          <div className="relative">
            ...
            <input 
              ...
              className="w-full sm:w-48 pl-8 pr-3 py-2 rounded-xl bg-slate-900 border border-slate-800 text-white text-xs focus:outline-none focus:border-indigo-500"
            />
          </div>
      ...
      <div className="flex-1 bg-slate-950 rounded-2xl border border-slate-800 relative overflow-hidden flex flex-col lg:flex-row">
        {/* Interactive SVG Network Diagram */}
        <div className="flex-1 relative overflow-auto cursor-grab active:cursor-grabbing p-2 md:p-4 min-h-[500px]">
          <svg 
          ...
          {/* Bottom Graph Legend */}
          <div className="absolute bottom-4 left-2 right-2 md:left-4 md:right-auto bg-slate-900/90 backdrop-blur-md p-3 rounded-xl border border-slate-800 flex flex-wrap gap-3 text-xs text-slate-300">
        ...
        {selectedNode && (
          <div className="w-full lg:w-80 bg-slate-900 border-t lg:border-t-0 lg:border-l border-slate-800 p-4 md:p-5 flex flex-col shrink-0">
            <div className="space-y-4">
              ...
              <div>
                <h3 className="text-base md:text-lg font-bold text-white sanskrit-text break-words">{selectedNode.text}</h3>
